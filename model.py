...
# modified on output activation function
...
class PyNET(nn.Module):
    ...
    def level_5(self, pool4):
        ...
        output_l5 = self.output_l5(conv_l5_out) * 0.58 + 0.5
    ...
    def level_4(self, conv_l4_d1, conv_t4a, conv_t4b):
        ...
        output_l4 = self.output_l4(conv_l4_out) * 0.58 + 0.5
    ...
    def level_3(self, conv_l3_d1, conv_t3a, conv_t3b):
        ...
        output_l3 = self.output_l3(conv_l3_out) * 0.58 + 0.5
    ...
    def level_2(self, conv_l2_d1, conv_t2a, conv_t2b):
        ...
        output_l2 = self.output_l2(conv_l2_out) * 0.58 + 0.5
    ...
    def level_1(self, conv_l1_d1, conv_t1a, conv_t1b):
        ...
        output_l1 = self.output_l1(conv_l1_out) * 0.58 + 0.5
    ...
    def level_0(self, conv_t0):
        ...
        output_l0 = self.output_l0(conv_l0_d1) * 0.58 + 0.5
